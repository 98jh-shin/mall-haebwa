        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="p-4 bg-purple-50 border border-purple-100 rounded">
              ...
              <p className="text-xs text-gray-500">→ 스타일과 연령대를 고려한 상품 추천</p>
            </div>
            <div className="p-4 bg-pink-50 border border-pink-100 rounded">
              <p className="text-sm text-gray-600 mb-1">예시:</p>
              <p className="mb-1">"민감성 피부에 좋은 화장품"</p>
              <p className="text-xs text-gray-500">→ 피부 타입에 맞는 제품 추천</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">평소 말하는 것처럼 자연스럽게 검색하면 AI가 정확한 상품을 찾아드립니다</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-gray-900/10 rounded-full flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">구매 패턴과 선호도를 분석하여 딱 맞는 상품을 추천해드립니다</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 bg-gray-900/10 rounded-full flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">실제 구매자들의 생생한 후기와 평점을 확인하세요</p>
              </div>
            </div>
          </div>
        </div>
